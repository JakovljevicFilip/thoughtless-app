...
1. All file imports must be grouped into the following types:
   ...
   3. Domain/runtime bindings.
      1. Domain and business logic: services, stores, repositories, aggregates, feature modules, and related types. Imports that include both runtime values and `import type` bindings stay here.
...
2. v1.1 — Added Helpers as a distinct, first-priority import group.
